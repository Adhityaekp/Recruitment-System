            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                        <li><a class="dropdown-item" href="/admin/profil"
                                style="border-bottom: 1px solid #0000007d; padding-bottom: 10px;"><i class="bi bi-person"></i><span class="ms-2">profil</span></a></li>
                        <li><a class="dropdown-item" href="/admin/login" style="padding-top: 10px;"><i class="bi bi-power"></i><span class="ms-2">Logout</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
